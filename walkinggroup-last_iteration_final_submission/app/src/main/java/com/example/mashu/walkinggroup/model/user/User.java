...
public class User extends IdItemBase {
    ...
    private CurrentUserTypeEnum userType;
    ...
    public String getUserDescription() {
        ...
        String[] nameSplit = name.split(" "); // Split name in 2 to get first and last name

        // Sequentially construct userDescription
        userDescription += nameSplit[0];
        if (nameSplit.length > 1) {
            userDescription += " " + nameSplit[1].substring(0,1) + ".";
        }
        userDescription += " -- " + totalPointsEarned + " Total Points";

        return userDescription;
    }

    public void setUserType(CurrentUserTypeEnum userType){
        this.userType = userType;
    }

    @JsonIgnore
    public CurrentUserTypeEnum getUserType() {
        return userType;
    }
}