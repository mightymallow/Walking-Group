...
public interface WGServerProxy {
    ...
    @GET("/permissions")
    Call<List<PermissionRequest>> getPermissionsForUser(
            @Query("userId") Long userId);

    @GET("/permissions")
    Call<List<PermissionRequest>> getPermissionsForUserWithGivenStatus(
            @Query("userId") Long userId,
    ...
    @GET("/permissions")
    Call<List<PermissionRequest>> getPermissionsWithGivenStatus(
            @Query("status") PermissionStatus status);

    @GET("/permissions")
    Call<List<PermissionRequest>> getPermissionsForGroupWithGivenStatus(
            @Query("status") PermissionStatus status,
            @Query("groupId") Long groupId);

    @GET("/permissions")
    Call<List<PermissionRequest>> getPermissionsForUserAndGroupWithGivenStatus(
            @Query("status") PermissionStatus status,
            @Query("userId") Long userId,
            @Query("groupId") Long groupId);
